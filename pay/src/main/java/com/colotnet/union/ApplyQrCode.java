...
/**
*@author star
*@version 创建时间：2019年7月22日上午10:23:48
*/
public class ApplyQrCode {
	...
	public static void main(String[] args) {
		...
		/***商户接入参数***/
		contentData.put("merId", "777290058171535");   		 				//商户号码，请改成自己申请的商户号或者open上注册得来的777商户号测试
		contentData.put("accessType", "0");            		 	//接入类型，商户接入填0 ，不需修改（0：直连商户， 1： 收单机构 2：平台商户）
		contentData.put("orderId",orderId);        	 	    //商户订单号，8-40位数字字母，不能含“-”或“_”，可以自行定制规则	
		contentData.put("txnTime", StringUtils.SDF2.format(new Date()));		 		    //订单发送时间，取系统时间，格式为YYYYMMDDhhmmss，必须取当前时间，否则会报txnTime无效
		contentData.put("txnAmt", "20000");						//交易金额 单位为分，不能带小数点
...
//		contentData.put("reqReserved", Base64.encodeBase64String("任意格式的信息都可以".toString().getBytes(DemoBase.encoding)));
		...
		contentData.put("backUrl","http://149.129.79.167:8080/callBack/callBack.do");
