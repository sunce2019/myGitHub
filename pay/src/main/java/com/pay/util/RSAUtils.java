...
public class RSAUtils {
     ...
     * @throws Exception
     */
    public static String verifyAndEncryptionToString(JSONObject resultbody, JSONObject resulthead, String privateKey, String publicKey) throws Exception {
        resulthead.put("sign",verify(resultbody,privateKey));
        JSONObject context = new JSONObject();
        context.put("businessContext", resultbody);
        context.put("businessHead", resulthead);
        logger.error("[签名加密前context] : {}", context);
