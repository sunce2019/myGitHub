...
<script language="javascript">
    ...
    function CampusController($scope, $http){
		...
		function refreshList(pageNo){
            ...
            $http.get('payorderList.do?pageNo=' + pageNo +'&userName='+$("#userName").val()+'&orderType='+$("#orderType").val()+'&flag='+$("#flag").val()+'&gameOrderNumber='+$("#gameOrderNumber").val()+'&start='+$("#start").val()+'&end='+$("#end").val(),config).success(function(data, status, headers, config){
