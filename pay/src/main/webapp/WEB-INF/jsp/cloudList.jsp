...
<%@ include file="../../jsp.js/cloudList-script.jsp"%>
<style>
	...
	<div class="well well-small">
	  ...
	  <div class="pull-right" style="float: none;margin-left: 20px;">
	 		...
	 		状态：<select id="flag" style="width: 100px">
	  		...
	  		<a class="btn btn-primary" id="ADDBANK" style="display: none" href="javascript:openDetailIframe('cloudAddPage.do');"><i class="icon-white icon-plus"></i>添加云闪付</a>
