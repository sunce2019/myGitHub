...
<%@ include file="../../jsp.js/ipList-script.jsp"%>
<style>
...
<div ng-controller='CampusController' class="list_right">
	<div class="well well-small">
      <div class="pull-left">
        <font class="titleText">ip白名单列表</font>
      </div>
	  <div class="pull-right">
	  		ip:<input type="text" id="ip" style="width: 100px"/>
	  		<a class="btn btn-primary" href="" ng-click="query()"><i class="icon-white icon-search"></i>查询</a>
	  		<a class="btn btn-primary" id="ADDIP" style="display: none" href="javascript:openDetailIframe('../ipDetail.do');"><i class="icon-white icon-plus"></i>添加账号</a>
