...
<%@ include file="../../jsp.js/systconfigDetail-script.jsp"%>
...
<div ng-controller='CampusController'>
  <div class="creatbox">
    <div class="middle">
        ...
        <input type="hidden" id="id" value="${systConfig.id}" >
		<%-- 主键 --%>
		<!-- 创建时间 -->
        <div class="input-label">
            <label class="label-text ">功能：</label>
        ...
        <div class="input-label">
            ...
            <div class="label-box form-inline control-group">
            	<input type="text" id="content" value="${systConfig.content}" style="width: 300px" /> 
                <span class="help-inline"></span>
            </div>
        </div>
        ...
        <div class="input-label">
            ...
            <div class="label-box form-inline control-group">
	  			...
	  			<option  value="1" <c:if test="${systConfig.flag==1}">selected="selected"</c:if>>开启</option>
	  			<option  value="2"<c:if test="${systConfig.flag==2}">selected="selected"</c:if>>关闭</option>
