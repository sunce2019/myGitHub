...
<%@ include file="../../jsp.js/aliList-script.jsp"%>
<style>
	...
	<div class="well well-small">
	  ...
	  <div class="pull-right" style="float: none;margin-left: 20px;">
	 		...
	 		状态：<select id="flag" style="width: 100px">
	  		...
	  		<a class="btn btn-primary" id="ADDBANK"  href="javascript:openDetailIframe('aliAddPage.do');"><i class="icon-white icon-plus"></i>添加支付宝付码</a>
