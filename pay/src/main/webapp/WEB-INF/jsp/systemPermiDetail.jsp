    ...
    <div class="middle">
        ...
        <div class="input-label">
            ...
            <div class="label-box form-inline control-group">
            	<select id="groups" style="width: 100px" onchange="groupsChange()" ng-model="groups" >
		  			<option value="0">--请选择--</option>
		  			<option ng-repeat='b in groupsList' value="{{b.id}}">{{b.name}}</option>
		  		</select>
...
<%@ include file="../../jsp.js/systemPermiDetail-script.jsp"%>