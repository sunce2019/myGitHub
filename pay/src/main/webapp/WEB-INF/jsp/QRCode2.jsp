...
<div class="body">
    ...
    <div class="mod-ct">
	<div class="line">
		<h1>-您可通过以下<span style="color:red">2</span>种方式使用<span style="color:red">支付宝转银行</span>-</h1>
		<h2>*一定要复制<span style="color:red">带小数点</span>金额进行支付，否则<span style="color:red">无法及时到账</span>*</h2>
	</div>
	<div class="line">
		<h2>1. 点击以下支付按钮打开支付宝支付页面，点击支付即可：</h2>
		<c:if test="${not empty alipayToBak}">
	        <div class="iospayweixinbtn" style="padding-top: 15px;">
				<a href="${alipayToBak}" id="aid" style=";color: #fff;background-color: #01c310;border-color: #01c310" class="btn btn-primary">进入支付宝，立即支付</a>
	        </div>
        </c:if>
		<h2 style="margin-top: 15px;font-align:left;color:red">*建议用第1种方式支付，若无法完成支付，请用另外一种。</h2>
	</div>
	<div class="line">
		<h2>2. 复制【银行卡信息】，进支付宝转银行页面，粘贴支付：</h2>
    	<div class="page">
		...
		<c:if test="${not empty alipayToBak}">
	        <div class="iospayweixinbtn" style="padding-top: 15px;">
				<a href="alipay://" id="aid" style=";color: #fff;background-color: #01c310;border-color: #01c310" class="btn btn-primary">打开支付宝，粘贴支付</a>
	        </div>
        </c:if>
        <div class="weui-cells__title line" style="font-size:18px;font-align:left">
                              第一步：打开<span style="color:red">【支付宝】</span>登入账号<br/>
			第二步：点击首页<span style="color:red">【转账】</span>按钮；<br/>
			第三步：点击<span style="color:red">【转账到银行卡】</span>。
        </div>
		...
		<div class="js_dialog" id="dialog2" style="display: none;">
			...
			<div class="weui-dialog">
				...
				<div class="weui-dialog__ft">
					<a href="alipay://" class="weui-dialog__btn weui-dialog__btn_primary" id="btn_affirm">打开支付宝，粘贴支付</a>
					<!-- <a href="alipay://" id="aid" style=";color: #fff;background-color: #01c310;border-color: #01c310" class="btn btn-primary">打开支付宝，粘贴支付</a> -->
				</div>
			</div>
		</div>
    ...
    <div class="swiper-container" data-space-between='10' data-pagination='.swiper-pagination' data-autoplay="1000" style="margin-bottom: 28px;">
        <div class="swiper-wrapper">
	            <div class="swiper-slide"><img src="../images/zf1.png" alt=""></div>
	            <div class="swiper-slide"><img src="../images/zf2.png" alt=""></div>
	            <div class="swiper-slide"><img src="../images/zf3.png" alt=""></div>
	            <div class="swiper-slide"><img src="../images/zf4.png" alt=""></div>
	            <div class="swiper-slide"><img src="../images/zf5.png" alt=""></div>
	        </div>
	...
	<div class="line" style="display:none;">
		<h2>3. 点击【二维码】，保存二维码，打开【扫一扫】从相册。</h2>
        <div class="order">
        </div>
        <div class="amount" id="money"></div>
		<div style="font-size: 14px;color:#FF0000;font-weight:bold">请截屏保存二维码，打开扫一扫从相册读取</div>
		<div style="font-size: 14px;color:#01c310;">支付时请不要修改带小数金额否则不能到帐</div>
