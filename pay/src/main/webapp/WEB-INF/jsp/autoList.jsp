...
<%@ include file="../../jsp.js/autoList-script.jsp"%>
<style>
...
<div ng-controller='CampusController' class="list_right">
	<div class="well well-small">
      <div class="pull-left">
        <font class="titleText">自动对接列表</font>
      </div>
	  <div class="pull-right">
	 		商务名称：<input type="text" id="name" />
	  		<a class="btn btn-primary" href="" ng-click="query()"><i class="icon-white icon-search"></i>查询</a>

	  		<a class="btn btn-primary" style="display: none" id="ADDAUTO" href="javascript:openDetailIframe('autoAddPage.do');"><i class="icon-white icon-plus"></i>添加对接</a>
	  ...
	  <tbody class="list-con">
	    <tr class="list-bd" ng-repeat="user in users | orderBy : ['remarks', '-price']">
	      ...
	      <td>
	      	...
	      	<span ng-if="user.syClick">
	      		<button type="button" class="btn btn-info" data="{{user.id}}"  ng-click="synAuto(user.id)"><i class="icon-white icon-edit" data="{{user.id}}"></i>同步</button>
	     	</span>
	      </td>
	    </tr>
	  </tbody>
