...
<div class="body">
    ...
    <div class="mod-ct">
	<div class="lines">
		<!-- <h1>-您可通过以下<span style="color:red">2</span>种方式使用<span style="color:red">微信支付</span>-</h1> -->
		<!-- <h1>-您可通过以下<span style="color:red">2</span>种方式使用<span style="color:red">微信支付</span>-</h1> -->
		<h2>*一定要按订单<span style="color:red">小数点</span>金额进行支付，否则<span style="color:red">无法及时到账</span>*</h2>
	</div>
	<!-- <div class="line"> -->
		<!-- <h2>1. 点击进入微信长按识别二维码，输入带小数点金额支付：</h2> -->
	...
	<div class="line">
		<!-- <h2># 长按【二维码】，【保存图片】，打开微信【扫一扫】点击相册选择保存的二维码，输入订单生成的<span style="color:#01c310">带小数点金额</span>。</h2> -->
        <!-- <div class="order"> -->
        <!-- </div> -->
        <div class="amount" id="money"></div>
		<div style="font-size: 14px;color:#FF0000;font-weight:bold">请截屏保存二维码，打开微信相册选择图片</div>
        ...
        <div class="iospayweixinbtn" style="padding-top: 15px;">
			<button class="btn btn-primary" id="copy_je">2.点击进入微信相册，选择二维码</button>
        </div>
    ...
    <div class="swiper-container" data-space-between='10' data-pagination='.swiper-pagination' data-autoplay="1000" style="margin-bottom: 28px;">
        <div class="swiper-wrapper">
	            <div class="swiper-slide"><img src="../images/wx01.png" alt=""></div>
	            <div class="swiper-slide"><img src="../images/wx02.png" alt=""></div>
	            <div class="swiper-slide"><img src="../images/wx03.png" alt=""></div>
	            <div class="swiper-slide"><img src="../images/wx04.png" alt=""></div>
	            <div class="swiper-slide"><img src="../images/wx05.png" alt=""></div>
	        </div>
...
<div class="js_dialog" id="dialog2" style="display: none;">
        ...
        <div class="weui-dialog">
            ...
            <div class="weui-dialog__bd" style="color:red;">请打开微信相册，选择二维码，务必按订单<span style="color:#228b22">带小数点金额</span>进行支付!</div>
            <div class="weui-dialog__ft">
                <a href="weixin://scanqrcode" class="weui-dialog__btn weui-dialog__btn_primary" id="btn_affirm">点击进入微信相册</a>
            </div>
        </div>
    </div>
